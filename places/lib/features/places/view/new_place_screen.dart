...
class _NewPlaceScreenState extends ConsumerState<NewPlaceScreen> {
  ...
  File? _newPlaceimage;
  PlaceLocation? _newPlaceLocation;
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate() &&
        _newPlaceimage != null &&
        _newPlaceLocation != null) {
      _formKey.currentState!.save();

      final place = Place(
        title: _newPlaceTitle,
        image: _newPlaceimage!,
        location: _newPlaceLocation!,
      );
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 12),
                LocationInput(
                  onLocationSelected: (loc) => _newPlaceLocation = loc,
                ),
                const SizedBox(height: 12),
                Row(
