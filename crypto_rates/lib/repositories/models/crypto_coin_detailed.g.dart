...
class CryptoCoinDetailedAdapter extends TypeAdapter<CryptoCoinDetailed> {
  @override
  final int typeId = 1;

  @override
  CryptoCoinDetailed read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, CryptoCoinDetailed obj) {
    writer
      ..writeByte(6)
      ..writeByte(0)
      ..write(obj.toSymbol)
  ...
  bool operator ==(Object other) =>
      ...
      other is CryptoCoinDetailedAdapter &&
